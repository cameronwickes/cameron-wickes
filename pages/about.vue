  ...
  <div id="about-page" class="page-wrapper about-page content-page">
    ...
    <main-section theme="sidebar-right">
      <template v-slot:default>
        <div class="content">
          <h3>Hi!</h3>
          <p>I’m Cameron Wickes, a third year student studying CyberSecurity at the University of Warwick.</p>
          <p>My journey into infosec started a while back, when a friend introduced me to an online cybersecurity course. Having loved Computer Science throughout my seven years at secondary school, I immediately jumped at the idea had completed the course within a couple of days.</p>
