  ...
  <div id="about-page" class="page-wrapper about-page content-page">
    ...
    <main-section theme="sidebar-right">
      <template v-slot:default>
        <div class="content">
          <h3>Hi!</h3>
          <p>I’m Cameron Wickes, an 18-year-old student from Cumbria, with a love for computers and information security.</p>
          ...
          <p>Through HMG and the SANS institute, I got the chance to participate in and complete the SANS SEC504 and SEC503 courses, which I enjoyed thoroughly. I hope to get the chance to participate in more events like these over the coming years.</p>
